...
LANGUAGES = [
    'Korean', 'German', 'Spanish', 'French', 'Chinese (Simplified)', 'Chinese (Traditional)',
    'Japanese', 'Italian', 'Portuguese', 'Russian', 'Arabic', 'Hindi', 'Turkish',
    'Dutch', 'Greek', 'Swedish', 'Polish', 'Hebrew', 'Vietnamese', 'Indonesian'
]
